## [1.22.0-dev.1](https://github.com/okkidwi/piko/compare/v1.21.0...v1.22.0-dev.1) (2025-01-20)

### Bug Fixes

* add "SettingsStatusLoadFingerprint" to fingerprints of `Hide Community Notes` and `Hide Live Threads` patch ([9c0232a](https://github.com/okkidwi/piko/commit/9c0232afd684024cc7028960aa2c65a82ce90cb7))
* **Bring back twitter:** Change the character "𝕏" into "Twitter". ([#441](https://github.com/okkidwi/piko/issues/441)) ([c20e16f](https://github.com/okkidwi/piko/commit/c20e16f80499df75176e9080f156e529f4f7d326))
* **Bring back twitter:** Change x icon to legacy twitter. ([3006f47](https://github.com/okkidwi/piko/commit/3006f47d973ffde1622ae1544590a11e923c68ab))
* **Custom download folder:** Restore compatibility with versions prior to 10.64 ([b88b00b](https://github.com/okkidwi/piko/commit/b88b00ba97632d62517c0e52a924c453ea022d7a))
* **Custom downloader:** Improve fingerprint ([2a2a4a4](https://github.com/okkidwi/piko/commit/2a2a4a4e2cdc6587c5c3b91bb3888918d7cd720d))
* **Feature Flags:** Use ListView instead of RecyclerView for a more reliable list. ([6f16b7f](https://github.com/okkidwi/piko/commit/6f16b7f7d61c81e7a21394f74b6e0d0e80ed9a55))
* Fix crash when opening feature flags ([2b1484d](https://github.com/okkidwi/piko/commit/2b1484d6c291a997283d98358cff98b0195acfed))
* Fix oopsie ([2af661f](https://github.com/okkidwi/piko/commit/2af661f5dfa1cc08e436ce04800ab230030a5079))
* Improve getUsername fingerprint ([af617af](https://github.com/okkidwi/piko/commit/af617af523bfa7df00a232a51364ea9e8ea4d34f))
* Missing `,` ([67675fe](https://github.com/okkidwi/piko/commit/67675fe381f0554cb69c0f061ec792df9e523479))
* Not creating `values-night-v31` dir ([e3f3491](https://github.com/okkidwi/piko/commit/e3f3491fea403f55d5200d1afc4aebd5c7507c2e))
* Opening mod settings with root installation results in crash ([8161644](https://github.com/okkidwi/piko/commit/81616443f2104eb1633c2c92c555f45341a7680e))
* Opening mod settings with root installation results in crash ([47e7670](https://github.com/okkidwi/piko/commit/47e7670cc09da736cbca6c9447f82d9fa343ee56))
* Remove debug prints ([33e4d08](https://github.com/okkidwi/piko/commit/33e4d08a58451217781914953c1ffb711ea8480b))
* Remove duplicate strings ([94c6642](https://github.com/okkidwi/piko/commit/94c66422e0ced2cbdfd820dfee60cedd2c68e636))
* **Remove Google Ad:** Include ads in the comments ([79d6e35](https://github.com/okkidwi/piko/commit/79d6e35144ffc6c81d3bb36499fc2c22e5a089ac))
* Resource strings getting corrupted, resulting on failure to patch on revanced manager ([#439](https://github.com/okkidwi/piko/issues/439)) ([1763137](https://github.com/okkidwi/piko/commit/1763137126b9a95df51fe23ce816853ccf0a8f44))
* switch jp to ja for Japanese translation ([c13cc87](https://github.com/okkidwi/piko/commit/c13cc87afeaea8cb623e7652a154a507ce532d61))
* tweet highlight color on hold ([#243](https://github.com/okkidwi/piko/issues/243)) ([b22ea42](https://github.com/okkidwi/piko/commit/b22ea426830b250abaa336e3b158dea34f82f6d6))
* **Twitter:** `Customize Navigation Bar items` in/from `10.53.0-beta.1` ([e8154fb](https://github.com/okkidwi/piko/commit/e8154fb0ffa91e6d3ed2812bed3f71a034f3bc01))
* **Twitter:** Add support for version 10.64.0-beta.1 ([c81378d](https://github.com/okkidwi/piko/commit/c81378d80275465acbf9caed5f48235b56395d56))
* **Twitter:** Bookmark in nav bar dix ([03fb96c](https://github.com/okkidwi/piko/commit/03fb96c485edb8931e9d37452f5a45c0b8a0103b))
* **Twitter:** Bookmark nav bar fix ([a6e8ab9](https://github.com/okkidwi/piko/commit/a6e8ab9c6817e15fa7c9ba182650f65ee2e65132))
* **Twitter:** Change patch name from `Enable app icon settings` -> `Enable app icons` ([5a7ef46](https://github.com/okkidwi/piko/commit/5a7ef469557e5cf4ecc9ce8465d73c20501dc524))
* **Twitter:** fix `Control video auto scroll` in 10.57 ([b7ae78c](https://github.com/okkidwi/piko/commit/b7ae78cd61b2f75d266e3fe3d57c5c21cd798e79))
* **Twitter:** Fix `Customize profile tabs` crash after `10.43` ([a38d621](https://github.com/okkidwi/piko/commit/a38d6213e06404fde21f6b5b8eddfcdfe8edd73e))
* **Twitter:** fix `Enable app icon settings` patch ([c2b6f79](https://github.com/okkidwi/piko/commit/c2b6f79b5c833c2441432b2511374361318e5507))
* **Twitter:** Fix `Hide nudge button` patch ([d7572fe](https://github.com/okkidwi/piko/commit/d7572feac66d44f0fe669073ee09bc09637adb9a))
* **Twitter:** Fix `Hide Promoted Trends` patch ([7052d25](https://github.com/okkidwi/piko/commit/7052d2583527354ee1a719f808993049364c8718))
* **Twitter:** Fix `Remove premium upsell` patch ([4df5e32](https://github.com/okkidwi/piko/commit/4df5e32088eb57702c5f30e20b3c75d2ec11ee87))
* **Twitter:** fix `Remove videos for you` patch ([b19f943](https://github.com/okkidwi/piko/commit/b19f943ee8a19ea158e89cc031ae037e43da6e50))
* **Twitter:** Fix aapt breakage due to tag mismatch ([730a51c](https://github.com/okkidwi/piko/commit/730a51c20f464bbe2b680004721161dd5f34dadf))
* **Twitter:** fix video entity hook in `10.58` ([e8a833d](https://github.com/okkidwi/piko/commit/e8a833d2123b92a40caf68b4f6798e822a6d1737))
* **Twitter:** Missing download option in immersive view ([6b0aa2c](https://github.com/okkidwi/piko/commit/6b0aa2c0d8d0f9192630e42abef418a834a95df0))
* **Twitter:** Share menu button add hook in/from 10.67 ([a640946](https://github.com/okkidwi/piko/commit/a640946e7045be359535ed0eead00ec80d2e10c4))
* unescaped character on `pl` string values ([a6444be](https://github.com/okkidwi/piko/commit/a6444bed45872df6a55be17a2b64dd2d40e2d16a))
* Unescaped characters ([8e539df](https://github.com/okkidwi/piko/commit/8e539dfd8c4e1ef6889357b9850a842db54a2a99))
* URL decode path to JAR containing spaces by osumatrix ([e6671ba](https://github.com/okkidwi/piko/commit/e6671ba4a8359db7aefa1ab20600e1f17144e002))
* Use UrlDecoder API available in older Android versions ([d9e6374](https://github.com/okkidwi/piko/commit/d9e63740b7eb7c8a4f44abf6d59998ea14194346))

### Features

* Add toggle for `Open browser chooser on opening links` patch ([6f217f0](https://github.com/okkidwi/piko/commit/6f217f08a8037be067791b318b750d7f6d91b4ea))
* **all:** Added `Export all activities` patch from ReVanced ([7cc405f](https://github.com/okkidwi/piko/commit/7cc405f7e900b85aaa172e8693cd4ca2e790451d))
* **Bring back twitter:** Add Japanese ([4eb08b5](https://github.com/okkidwi/piko/commit/4eb08b554eaf92958e0e159647fc71b35340e2b2))
* **Customize side bar items:** Allow for hiding of the "Jobs" item ([14ce811](https://github.com/okkidwi/piko/commit/14ce811a7b4d885fa6779524aad0b41034a2d8d0))
* Enable recent patches by default ([e84f358](https://github.com/okkidwi/piko/commit/e84f358e494830fdecdc3dd12662b5f5ccd644b3))
* **Hook feature flag:** Added ability to search for supported flags. ([28a2c0a](https://github.com/okkidwi/piko/commit/28a2c0a6ca97fa50711ce44cfa1f20b5147e906f))
* Quick settings button is now optional ([e9e54e5](https://github.com/okkidwi/piko/commit/e9e54e5e44437b92db9700c363f0abd9117cc325))
* Remove throw file ([86bff99](https://github.com/okkidwi/piko/commit/86bff993636928c67ca95dabeebcf1f5cc191a36))
* **Translations:** Add `Turkish` ([bf70b91](https://github.com/okkidwi/piko/commit/bf70b913775ec299a87725b15d30bb2506da7a5d))
* **Translations:** Add Arabic translations ([c1d797b](https://github.com/okkidwi/piko/commit/c1d797b21bcbf0752bb48c94e4009e8221e46b36))
* **Translations:** Add Brazilian Portuguese translations [Bring back Twitter] ([3a831d3](https://github.com/okkidwi/piko/commit/3a831d3869a5fbbb22342cbfe1859241b2126fa5))
* **Translations:** Add japanese ([c123d8e](https://github.com/okkidwi/piko/commit/c123d8ed58f92dce6337cd194be64e21b3d9559c))
* **Translations:** Add polish translation ([8102f35](https://github.com/okkidwi/piko/commit/8102f35bab392acd8337fdf363c8891e3b96f629))
* **Translations:** Add simplified Chinese translation ([7662a34](https://github.com/okkidwi/piko/commit/7662a34a87e2dd5d819188993054a8fc4808ef03))
* **Translations:** Add Simplified Chinese translations and Taiwanese Traditional Chinese translations[Bring back Twitter] ([d44bfd7](https://github.com/okkidwi/piko/commit/d44bfd73f0063703179c097d68738063a000d80b))
* **Translations:** Added Traditional Chinese translation ([1c0b10a](https://github.com/okkidwi/piko/commit/1c0b10af732a6e159862a99369b57368cbbdab91))
* **Translations:** Fix Simplified Chinese Translation ([ec0a3dc](https://github.com/okkidwi/piko/commit/ec0a3dcadf4027c3a6a6d411d44043d245b5ca29))
* **Translations:** Update `japanese` ([444623f](https://github.com/okkidwi/piko/commit/444623faaa5761b33445705e04e5c3078ff88124))
* **Translations:** Update `japanese` ([f5ece19](https://github.com/okkidwi/piko/commit/f5ece191a724f7bc0aed0cb90df8902f6d9e110b))
* **Translations:** Update Russian translation ([54ba664](https://github.com/okkidwi/piko/commit/54ba664921218ce79218e4ce4a9a2d4d2d1cf1b6))
* **Translations:** Update Russian translation ([3606c10](https://github.com/okkidwi/piko/commit/3606c101ae1630c303a8ed55c4e21ab75346fbbe))
* **Translations:** Updated Brazilian Portuguese ([e25ec0e](https://github.com/okkidwi/piko/commit/e25ec0ecee9e576f6fe74c2bf70d750399275b7e))
* **Translations:** Updated Brazilian Portuguese ([45aac73](https://github.com/okkidwi/piko/commit/45aac7374731e2d3b4a24e3c22ad5aaaccbbc33a))
* **Translations:** Updated Traditional Chinese string-zh-rCN.xml ([6cc2373](https://github.com/okkidwi/piko/commit/6cc2373e417a1ed386a2682f970662e367033b43))
* **Translations:** Updated Traditional Chinese string-zh-rTW.xml ([6787c28](https://github.com/okkidwi/piko/commit/6787c28318762382d73f1eb8c6ad9abc4b2ee2e6))
* **translation:** Update Simplified Chinese translation ([4f3027a](https://github.com/okkidwi/piko/commit/4f3027a2279e9cd1a2cc010d190cab3551c45cd4))
* **Translation:** Update Simplified Chinese translation ([b9fe0e8](https://github.com/okkidwi/piko/commit/b9fe0e83a3ddd1fd2633dca6403723c4dbea32ce))
* **Twitter:** Added `Ability to copy video media link` patch ([14bfdc7](https://github.com/okkidwi/piko/commit/14bfdc7d0b2d1fbf6644e496cbc186bd5ade3494))
* **Twitter:** Added `Control video auto scroll` patch ([7a21924](https://github.com/okkidwi/piko/commit/7a21924dc7f30a15feef1797b0416c91de27d1e4))
* **Twitter:** Added `Custom downloader` ([3d5941e](https://github.com/okkidwi/piko/commit/3d5941e226c1fb9402edeeb138c1c974026e0598))
* **Twitter:** Added `Custom translator` patch ([737fb9e](https://github.com/okkidwi/piko/commit/737fb9eaa0b8da7f020b93c314f5da60f961e345))
* **Twitter:** Added `Customise post font size` patch ([ea608e0](https://github.com/okkidwi/piko/commit/ea608e09b7b0775f38ca1914503e1b54dc7b73f9))
* **Twitter:** Added `Customize explore tabs` patch ([4be6a7f](https://github.com/okkidwi/piko/commit/4be6a7fe6ace42ca299d2e4bc7f9a963774f3bcd))
* **Twitter:** Added `Customize Inline action Bar items` patch ([05b06f9](https://github.com/okkidwi/piko/commit/05b06f9fa4a183c9626acc7fda69c0bebdbae761))
* **Twitter:** Added `Customize Navigation Bar items` patch ([9c6f59c](https://github.com/okkidwi/piko/commit/9c6f59cf6f40cc4d4d61b13bf496f800f452c0c1))
* **Twitter:** Added `Customize reply sort filter` patch ([121b8a6](https://github.com/okkidwi/piko/commit/121b8a6e9345ea462ad9cb06f7b20f863fc08d4a))
* **Twitter:** Added `Customize search suggestions` patch ([aaca565](https://github.com/okkidwi/piko/commit/aaca565c650d6cf4b2cbb8abf2e206efe9983cb1))
* **Twitter:** Added `Customize search tab items` patch ([9edc97a](https://github.com/okkidwi/piko/commit/9edc97a89e61f28a5cd9a419d167a6c51a1a9816))
* **Twitter:** Added `Customize side bar items` patch ([ca0d28f](https://github.com/okkidwi/piko/commit/ca0d28f96d65d7d7f300f6089029ec24e55802b4))
* **Twitter:** Added `Customize timeline top bar` patch ([245c5f6](https://github.com/okkidwi/piko/commit/245c5f6f8f82e98b405ec853624c3cad52ae1764))
* **Twitter:** Added `Debug Menu` patch ([7d5ca77](https://github.com/okkidwi/piko/commit/7d5ca77bf633a8dfcd8657d12b24bd076b2f5d11))
* **Twitter:** Added `Delete from database` patch ([d785660](https://github.com/okkidwi/piko/commit/d7856602786d3fb9d7a8721f05d80be97bc4fd3b))
* **Twitter:** Added `Disable auto timeline scroll on launch` patch ([b8d431e](https://github.com/okkidwi/piko/commit/b8d431ea44a2b53f9065c226116d86ec1fb7b70f))
* **Twitter:** Added `Enable app downgrading` patch ([9f581ce](https://github.com/okkidwi/piko/commit/9f581ce41b202fe7e5dfbb634a18a5bf6fb8faa5))
* **Twitter:** Added `Enable force HD videos` patch ([d316612](https://github.com/okkidwi/piko/commit/d3166121ac39adf45440e6888b43487e398f61e6))
* **Twitter:** Added `Enable PiP mode automatically` patch ([59d6b67](https://github.com/okkidwi/piko/commit/59d6b6723cbff6fa96218fb6210e2cb0b8bc1338))
* **Twitter:** Added `Hide Buy Premium Banner` patch ([7ba6419](https://github.com/okkidwi/piko/commit/7ba64198f289ffac2e3d397e5bf0f1137ba2aa2b))
* **Twitter:** Added `Hide followed by context` patch ([261e1d0](https://github.com/okkidwi/piko/commit/261e1d0156702a4a72105b430d50e59e88795198))
* **Twitter:** Added `Hide hidden replies` patch ([431acc4](https://github.com/okkidwi/piko/commit/431acc435675002c7d9f068b4fc3ebade2487db3))
* **Twitter:** Added `Hide nudge button` patch ([ad27484](https://github.com/okkidwi/piko/commit/ad27484f4cc0d727cf07cb4f202c8ddd6b582d67))
* **Twitter:** Added `Patch info` section ([7f794c3](https://github.com/okkidwi/piko/commit/7f794c3cc88b1fd1170f43589aaff356532bb9e4))
* **Twitter:** Added `Profile tabs customisation` ([db0298b](https://github.com/okkidwi/piko/commit/db0298b9f0cc6066974630d29812a2e8a11e7262))
* **Twitter:** Added `Remove main event` patch ([806598d](https://github.com/okkidwi/piko/commit/806598d7154c538fb238f3d9b186746cb8c956bf))
* **Twitter:** Added `Remove premium upsell` patch ([37525de](https://github.com/okkidwi/piko/commit/37525de868c38254cbfd20b58d4fd077b0c14ca2))
* **Twitter:** Added `Remove top people in search` patch ([95b5ef9](https://github.com/okkidwi/piko/commit/95b5ef902e6f595093b2304e5b2a8189f273389c))
* **Twitter:** Added `Remove videos for you` patch ([25934a2](https://github.com/okkidwi/piko/commit/25934a2b58a8eefc05d4313b623580371d964a12))
* **Twitter:** Added `Round off numbers` patch ([b1c1b13](https://github.com/okkidwi/piko/commit/b1c1b1361b55f08e2eba64e086943b30b2dc1212))
* **Twitter:** Added ability to export and import prefs & feature flags ([01cdd6b](https://github.com/okkidwi/piko/commit/01cdd6b7b25f08a3b258704f38c25b11aa1a9703))
* **Twitter:** Added ability to export and import prefs & feature flags ([a591133](https://github.com/okkidwi/piko/commit/a591133381a0b620a82d83580757300042680c85))
* **Twitter:** Added ability to reset pref and flags ([4aaeb09](https://github.com/okkidwi/piko/commit/4aaeb09ce6c38c6513be6293140a7e7e0b796f28))
* **Twitter:** Added Remember filter for `Customize reply sort filter` ([24df398](https://github.com/okkidwi/piko/commit/24df3987e5008aeca52c11a8b20714766cdafff1))
* **Twitter:** Added tab redirects hook (for Bookmark Navbar) ([f01b418](https://github.com/okkidwi/piko/commit/f01b418fcc13e9fe54d845eab3bea1cd62687f9f))
* **Twitter:** Custom deeplinks ([325a281](https://github.com/okkidwi/piko/commit/325a281225b1379b310d8ba14629bdbae0b314e5))
* **ui:** app wide monet theming in light mode ([46f920b](https://github.com/okkidwi/piko/commit/46f920bd35841e3df85617aed6a439f0df114d7b))
* **ui:** full app wide material theming in dim mode replacing dark blue ([52d7444](https://github.com/okkidwi/piko/commit/52d74441f0ae509ec66ba04b3939c90deb4755c5))
* use browser chooser when opening links ([cc165f4](https://github.com/okkidwi/piko/commit/cc165f41db4392d9dcc554ee8800333e87dc8cdf))

### Updates

* Add spanish to languages ([e9b8efd](https://github.com/okkidwi/piko/commit/e9b8efdb3570fa516f06a736f2709d1c166df1bf))
* **Bring back twitter:** Create strings file if not found ([9f51a5c](https://github.com/okkidwi/piko/commit/9f51a5cf9525e829166a5b82261abe209823eb5b))
* **Custom sharing domain:** require settings patch also turned it on by default. ([6a3777f](https://github.com/okkidwi/piko/commit/6a3777f0631a97dff3a31129a45cfc671e71283d))
* Enable `Customize profile tabs` patch by default ([a8543bf](https://github.com/okkidwi/piko/commit/a8543bf0d2eebe8a1580870b95c75a890e845ff4))
* Enable `Hide Live Threads` patch by default ([b9862b5](https://github.com/okkidwi/piko/commit/b9862b50b97741721448c0ea667769b0024961c9))
* **Hook feature flag:** Improve flag matching in search. ([d7f0827](https://github.com/okkidwi/piko/commit/d7f0827218a9501a0b2e061990ce60a0af18ba0e))
* Improve quick settings appearance ([6dc27b4](https://github.com/okkidwi/piko/commit/6dc27b4a888d0028e455be1e1b41b83cdd7f7940))
* Improve the retrieval of the patches version ([ba940da](https://github.com/okkidwi/piko/commit/ba940da7b84e52345533dd3802410811b7fa4cb7))
* Improved the hooking of the recyclerview methods. also fixes the crash when opening feature flags. ([25e5bc4](https://github.com/okkidwi/piko/commit/25e5bc422c3893747b8fadd0744833a4ecb7b6ea))
* Russian translation ([42b68e9](https://github.com/okkidwi/piko/commit/42b68e96fccca505a60d6eb2682cbfb7f7acfb17))
* Translation updates ([509dfbb](https://github.com/okkidwi/piko/commit/509dfbb9e92511379406979a19b131a685229fc6))
* Translations ([d3ae8ec](https://github.com/okkidwi/piko/commit/d3ae8ec55dced8d7d09146c224d332f72414382a))
* **Translations:** Improved & updates polish translations ([9bbb9f4](https://github.com/okkidwi/piko/commit/9bbb9f4ea8c5aa3fee0be0580a281dc967f7981a))
* **Translations:** Translation updates ([4bf8a8d](https://github.com/okkidwi/piko/commit/4bf8a8dd954a7013a65ceee9d39521fd445d069d))
* **Translations:** Update `Indonesian (Bahasa)` ([1442b6c](https://github.com/okkidwi/piko/commit/1442b6c798f5fd58e1381f1e23581cc8f55ca0fc))
* **Translations:** Update `Indonesian (Bahasa)` ([b9488d6](https://github.com/okkidwi/piko/commit/b9488d6fed4e521f80ca9c292112130d806f77aa))
* **Translations:** Update `japanese` ([9fce4a2](https://github.com/okkidwi/piko/commit/9fce4a20d7db77992bd92eaa5ada75af8af56103))
* **Translations:** Update `Japanese` ([b326d10](https://github.com/okkidwi/piko/commit/b326d10599db407e1e922ac8d6d2694a67c6e42b))
* **Translations:** Update Brazilian Portuguese ([8745f61](https://github.com/okkidwi/piko/commit/8745f61c060a62152bd84ee510d835ac8346e01e))
* **Translations:** Update Brazilian Portuguese ([7de9493](https://github.com/okkidwi/piko/commit/7de949327844e06e1fda1946bed5555fb150b67c))
* **Translations:** Update Japanese ([61ff288](https://github.com/okkidwi/piko/commit/61ff288ba6aa086c984a317a52fb7228710878f5))
* **Translations:** Update polish ([9d8f4fc](https://github.com/okkidwi/piko/commit/9d8f4fc57174b0cc28540e29b7b9725af5e65421))
* **Translations:** Update polish translations ([6200d65](https://github.com/okkidwi/piko/commit/6200d657b5db4040f10ec4f82054ad440b09221c))
* **Translations:** Update Russian translation ([8b1c4c8](https://github.com/okkidwi/piko/commit/8b1c4c8185a482a72ecc7cdc2dbb31940660a70d))
* **Translations:** update simplified chinese translation ([3e5a8fd](https://github.com/okkidwi/piko/commit/3e5a8fdd07a7f7646e860a76fc81165b67b211bf))
* **Translations:** update simplified chinese translation ([b24f7cc](https://github.com/okkidwi/piko/commit/b24f7cca23c6b003c7246951de8a361ff5ef2dfb))
* **Translations:** Update simplified chinese translation ([147cb29](https://github.com/okkidwi/piko/commit/147cb29cd4e4f260fd168934584971e6620e7f9b))
* **Translations:** Update translations ([9686863](https://github.com/okkidwi/piko/commit/968686390263fa700488deb5d87085470267c7cf))
* **Translations:** Update Turkish translations ([bab6ae9](https://github.com/okkidwi/piko/commit/bab6ae97e400d89f7551eebfc1ee04f385a1c62c))
* **Translation:** Update Hindi translations [Bring back Twitter] ([20ac044](https://github.com/okkidwi/piko/commit/20ac044efe3f96f2cefadce6cb42a00e1a820840))
* **Twitter:** Added hide 'Settings and privacy' in `Customize side bar items` ([cb01885](https://github.com/okkidwi/piko/commit/cb018852c8af8caaf4b986444208ab00a39eab41))
* **Twitter:** Added strings ([fad9b1a](https://github.com/okkidwi/piko/commit/fad9b1a9fd79b164c713fe35b61bad8ed3d9373b))
* **Twitter:** Change Quick Btn path ([7febdf6](https://github.com/okkidwi/piko/commit/7febdf612212ba61638fd818121c8cc4b9db8ed8))
* **Twitter:** Enable new patches by default ([19f9149](https://github.com/okkidwi/piko/commit/19f9149452fafae83584508fe7ae9d594fcf5543))
* **Twitter:** Updated `Enable force HD videos` patch description ([86ea041](https://github.com/okkidwi/piko/commit/86ea0418d3606b6e04f8fbea8fc530aba5316f0f))
* **Twitter:** updated string ([60afc68](https://github.com/okkidwi/piko/commit/60afc683c4be02ba4d5cdc92879aad2e6755b14b))
* **Twitter:** Updated strings ([3cb159e](https://github.com/okkidwi/piko/commit/3cb159e57d66e22b7c2f638e5d0b7422a4ef2a10))

### Refactors

* Add `enableSettings` helper function ([7d6ebd5](https://github.com/okkidwi/piko/commit/7d6ebd579a32161bf782f2ce0843817dbbf8b69d))
* Add `SettingsPatch ` dependencies to patches ([6d252f8](https://github.com/okkidwi/piko/commit/6d252f84c6086b15e7be4a58676254748bd8ff73))
* **Custom Downloader:** Improve getting of tweet method declarations ([5237e49](https://github.com/okkidwi/piko/commit/5237e496140cc94fb9beb4a72057d927527dd78b))
* Optimize imports ([2f42add](https://github.com/okkidwi/piko/commit/2f42add01463d36336423574b76670c6cbf2659a))
* **Twitter:** `Add ability to copy media link` patch ([e8ef551](https://github.com/okkidwi/piko/commit/e8ef5519abf64594676f0de1e0e3e01b06571079))
* **Twitter:** Added 'Native features' section ([12d2bda](https://github.com/okkidwi/piko/commit/12d2bdaafd111eee81f22bdafa306c3493754c80))
* **Twitter:** Added `No shortened URL` as a settings toggle ([ea33a30](https://github.com/okkidwi/piko/commit/ea33a308c277e3e40e085112e970406cee64f0cd))
* **Twitter:** Added missing patches names ([b3fda95](https://github.com/okkidwi/piko/commit/b3fda9558251eda91e6e3b43e994a9dbcdb1daac))
* **Twitter:** Added multiple language support for `Bring back twitter` ([9eacab3](https://github.com/okkidwi/piko/commit/9eacab308dab4f4ea1de834d81308e9d616766c2))
* **Twitter:** Added Native download filename customization ([99a10b1](https://github.com/okkidwi/piko/commit/99a10b1615ffa3fb72df0ad283255e9c837a012f))
* **Twitter:** Added quick settings button in side drawer ([c0152e3](https://github.com/okkidwi/piko/commit/c0152e327e8b2e3fa2ad57d63c35738d4575cc98))
* **Twitter:** Added toggle for `Show sensitive media` patch ([cac4fe7](https://github.com/okkidwi/piko/commit/cac4fe747640e37dc9155c63f23082c44963c05d))
* **Twitter:** Change translator icon ([bf5f027](https://github.com/okkidwi/piko/commit/bf5f027f80507cf0db5b3dfd208d26b131987eca))
* **Twitter:** Changed `Top Articles ` string ([b590695](https://github.com/okkidwi/piko/commit/b5906957cb8cda07a40e02008b5ad69ad6389637))
* **Twitter:** Combined `customize patch` into single class ([6c04aed](https://github.com/okkidwi/piko/commit/6c04aed5ec958cb86471d94dd1729c4ad7952c8d))
* **Twitter:** Force enable `Enable app icon settings` patch ([ee605f1](https://github.com/okkidwi/piko/commit/ee605f11f8c95e6b8cf5d1d1cf2357593e1ea318))
* **Twitter:** load `Utils.load()` dynamically ([5379276](https://github.com/okkidwi/piko/commit/53792768e4e5465559478041f51e516159c1f93f))
* **Twitter:** Major string changes ([f22fdf0](https://github.com/okkidwi/piko/commit/f22fdf086184f71447d2696461d76914dbef731d))
* **Twitter:** More strings refactor ([d5a629f](https://github.com/okkidwi/piko/commit/d5a629f39bc4c15be1914a6ab98034129ed53f64))
* **Twitter:** Rearrange `Bring back twitter` resources ([a476924](https://github.com/okkidwi/piko/commit/a47692437d7f80c44b67ff61204b02db93743b86))
* **Twitter:** refactor `Custom downloader` patch ([42cc752](https://github.com/okkidwi/piko/commit/42cc752c599f978f455f84ae9a917f7bb457af98))
* **Twitter:** Refactor `Custom downloader` patch ([1e966f7](https://github.com/okkidwi/piko/commit/1e966f7f519b7d947e0b516f8bc0ca0c55c1d623))
* **Twitter:** Refactor `Enable app icon settings` patch ([e7b3d0e](https://github.com/okkidwi/piko/commit/e7b3d0e3bfdfb5fc7dff3564c021c04d7d2d564c))
* **Twitter:** refactor default feature flag hook ([6fd6001](https://github.com/okkidwi/piko/commit/6fd60012c74c83944fd80b57e444c3f54da5823c))
* **Twitter:** Refactor hooks filename ([2daa292](https://github.com/okkidwi/piko/commit/2daa2922c7225711fd1aa5d0556493e068026e0a))
* **Twitter:** refactor values of list preference ([e0e5c5b](https://github.com/okkidwi/piko/commit/e0e5c5b8639efcd5eecd6476bc59b7f125d5b851))
* **Twitter:** renamed 'Share menu button' fingerprints to hooks ([395c221](https://github.com/okkidwi/piko/commit/395c2217fc5f5b18cdc76568c3845140f76940d6))
* **Twitter:** Renamed patch `Remove Buy Premium Banner` to `Remove message prompts Banner` ([45dbad8](https://github.com/okkidwi/piko/commit/45dbad85abb22e0ab74d1dd0bcd977c4aeef3349))
* **Twitter:** Separated `App icon` and `Navigation icon` patch ([8a67f12](https://github.com/okkidwi/piko/commit/8a67f12e0430dbd06a6184a150ba75da832a2c54))
* **Twitter:** Seperated/Added `Remove superhero event` patch ([d60ee17](https://github.com/okkidwi/piko/commit/d60ee17294b311bb964e3cc6200465218d7baca3))
* **Twitter:** Strings in 'Customization' ([c52c2c0](https://github.com/okkidwi/piko/commit/c52c2c01948bdea5593636a99502d8b5c6c41dca))
* **Twitter:** Strings in 'Customization' ([a75221b](https://github.com/okkidwi/piko/commit/a75221b80c1d3223b88890a95ca1610432defbe2))
* **Twitter:** Strings refactor ([2db8866](https://github.com/okkidwi/piko/commit/2db88663e70745ef81024d896ad5204c29b1ba06))
* **Twitter:** updated profile tab string ([1af7846](https://github.com/okkidwi/piko/commit/1af78461de97661a82d5eb638300402eaab00afe))

### Perfomance

* **Bring back twitter:** Optimize string replacement ([#440](https://github.com/okkidwi/piko/issues/440)) ([7e61023](https://github.com/okkidwi/piko/commit/7e6102351d9488f89489f87df2ec45d6d0d178d8))
